...
public class PDFAP {
    ...
    public void PDFCreator(){
        ...
        try{
            ...
            while(rs.next()){
            String file_name="C:\\Users\\Mega-PC\\Desktop\\XCode\\src\\xcode\\PDFGen\\"+rs.getString("Max(c.commande_id)")+"_"+rs.getString("u.nom")+"_"+rs.getString("u.prenom")+".pdf";
            ...
            String filename = "C:\\Users\\Mega-PC\\Desktop\\XCode\\src\\xcode\\images\\fanny.png";
