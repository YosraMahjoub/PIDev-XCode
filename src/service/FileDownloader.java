...
//public class HTTPDownloadUtil {
    ...
    public void downloadFile(String fileURL) throws IOException {
        ...
        int responseCode = httpConn.getResponseCode();// gets answer from the http indicating if everything is okay or not 
 
        // always check HTTP response code first
        if (responseCode == HttpURLConnection.HTTP_OK) {
            String disposition = httpConn.getHeaderField("Content-Disposition");//the value of the named header field
